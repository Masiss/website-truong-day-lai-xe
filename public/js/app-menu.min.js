!function (e, n, a) {
    ...
    var i = a("body"), s = (a(e), a('div[data-menu="menu-wrapper"]').html()),
    ...
    a.app.menu = {
        ...
        change: function (n) {
            ...
            "vertical-menu" !== s && "vertical-menu-modern" !== s || this.toOverlayMenu(t.name, s), i.is(".horizontal-layout") && !i.hasClass(".horizontal-menu-demo") && (this.changeMenu(t.name), a(".menu-toggle").removeClass("is-active")), "xl" == t.name && a('body[data-open="hover"] .main-menu-content .dropdown').on("mouseenter", (function () {
                ...
                if (n) {
                    var t = a(e).height(), i = a(this).position().top, s = n.offset().left, o = n.width();
        ...
        expand: function () {
            !1 === this.expanded && ("vertical-menu-modern" == i.data("menu") && a(".modern-nav-toggle").find(".collapse-toggle-icon").replaceWith(feather.icons.disc.toSvg({class: "d-none d-xl-block collapse-toggle-icon primary font-medium-4"})), this.transit((function () {
        ...
        collapse: function () {
            !1 === this.collapsed && ("vertical-menu-modern" == i.data("menu") && a(".modern-nav-toggle").find(".collapse-toggle-icon").replaceWith(feather.icons.circle.toSvg({class: "d-none d-xl-block collapse-toggle-icon primary font-medium-4"})), this.transit((function () {
        ...
        changeMenu: function (e) {
            ...
            var n = a('div[data-menu="menu-wrapper"]'),
                ...
                l = a('li[data-menu="dropdown"]'), m = a('li[data-menu="dropdown-submenu"]');
        ...
        bind_events: function () {
            ...
            a(".navigation-main").on("mouseenter.app.menu", "li", (function () {
                ...
                if (i.hasClass("menu-collapsed") && "vertical-menu-modern" != i.data("menu")) {
                    ...
                    var n, t, s, o = e.find("span.menu-title").clone();
        ...
        collapse: function (e, n) {
            var t = e.children("ul"), i = e.children().first(), s = a(i).outerHeight();
            e.css({
