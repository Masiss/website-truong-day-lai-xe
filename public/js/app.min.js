...
window.colors = {
    ...
    "use strict";
    var s = t("html"), n = t("body"), o = "#4e5154", r = "../../../app-assets/";
    if ("laravel" === t("body").attr("data-framework") && (r = t("body").attr("data-asset-path")), t.fn.dataTable && t.extend(t.fn.dataTable.ext.classes, {
        ...
        !1 === t.app.nav.initialized && t.app.nav.init({speed: 300}), Unison.on("change", (function (a) {
            t.app.menu.change(r)
        }));
        ...
        t(".char-textarea").on("keyup", (function (e) {
            !function (e, s) {
                var n = parseInt(t(e).data("length")), r = t(".textarea-counter-value"), l = t(".char-textarea");
                (function (a) {
    ...
    var p = t(".search-input input").data("search"), v = t(".bookmark-wrapper"),
        ...
        C = t(".nav-link-search"), k = t(".search-input"), w = t(".search-input input"),
        y = t(".search-input .search-list"), x = t(".app-content"), S = t(".bookmark-input .search-list");
    if (g.on("click", (function (a) {
        ...
        for (var o = 0; o < e.length; o++) {
            ...
            s += '<li class="auto-suggestion ' + n + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + e[o].firstChild.href + '><div class="d-flex justify-content-start align-items-center">' + feather.icons[r].toSvg({class: "me-75 " + l}) + "<span>" + e[o].firstChild.dataset.bsOriginalTitle + "</span></div>" + feather.icons.star.toSvg({class: "text-warning bookmark-icon float-end"}) + "</a></li>"
        }
    ...
    t(".search-list-main").mouseenter((function () {
            ...
            if (t("ul.search-list li").remove(), t(this).parent().hasClass("bookmark-input") && (n = !0), "" != e) {
                ...
                t.getJSON(r + "data/" + p + ".json", (function (a) {
                    for (var m = 0; m < a.listItems.length; m++) {
                        ...
                        0 == a.listItems[m].name.toLowerCase().indexOf(e) && f < 5 && (o += '<li class="auto-suggestion ' + (0 === f ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + a.listItems[m].url + '><div class="d-flex justify-content-start align-items-center">' + feather.icons[a.listItems[m].icon].toSvg({class: "me-75 "}) + "<span>" + a.listItems[m].name + "</span></div>" + h + "</a></li>", f++)
                    }
                ...
                for (var m = t("ul.nav.navbar-nav.bookmark-icons li"), v = "", g = 0; g < m.length; g++) {
                    ...
                    v += '<li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100" href=' + m[g].firstChild.href + '><div class="d-flex justify-content-start align-items-center">' + feather.icons[C].toSvg({class: "me-75 "}) + "<span>" + m[g].firstChild.dataset.bsOriginalTitle + "</span></div>" + feather.icons.star.toSvg({class: "text-warning bookmark-icon float-end"}) + "</a></li>"
                }
        ...
        if (a.stopPropagation(), t(this).hasClass("text-warning")) {
            ...
            var n, o = t(this).parent()[0].href, r = t(this).parent()[0].innerText,
            ...
            n = '<li class="nav-item d-none d-lg-block"><a class="nav-link" href="' + o + '" data-bs-toggle="tooltip" data-bs-placement="bottom" title="' + r + '">' + feather.icons[l].toSvg({class: "ficon"}) + "</a></li>", t("ul.nav.bookmark-icons").append(n), t('[data-bs-toggle="tooltip"]').tooltip()
        }
    ...
    t(".nav-link-style").on("click", (function () {
        ...
        e = "dark-layout" !== a ? "dark-layout" : a === n ? "light-layout" : n || "light-layout", localStorage.setItem(T + "-prev-skin", a), localStorage.setItem(T + "-current-skin", e), function (a) {
            var e = t(".nav-link-style"), n = z(), o = t(".main-menu"), r = t(".header-navbar"), l = a || n;
