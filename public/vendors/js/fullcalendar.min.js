...
var FullCalendar = function (e) {
    ...
    function C(e, t, n, r, o, i, a, s, l, u) {
        ...
        for (n.__k = [], p = 0; p < t.length; p++) if (null != (v = n.__k[p] = null == (v = t[p]) || "boolean" == typeof v ? null : "string" == typeof v || "number" == typeof v || "bigint" == typeof v ? g(null, v, null, null, v) : Array.isArray(v) ? g(m, {children: v}, null, null, null) : v.__b > 0 ? g(v.type, v.props, v.key, null, v.__v) : v)) {
            ...
            I(e, v, h = h || c, o, i, a, s, l, u), y = v.__e, (f = v.ref) && h.ref != f && (D || (D = []), h.ref && D.push(h.ref, null, v), D.push(f, v.__c || y, v)), null != y ? (null == S && (S = y), "function" == typeof v.type && null != v.__k && v.__k === h.__k ? v.__d = l = w(v, l, e) : l = _(e, v, h, b, y, l), u || "option" !== n.type ? "function" == typeof n.type && (n.__d = l) : e.value = "") : l && h.__e == l && l.parentNode != e && (l = E(h))
        }
    ...
    function ot(e, t, n, r) {
        var o = ut([t, 0, 1 + it(t, n, r)]), i = rt(e), a = Math.round(Qe(o, i));
        ...
        for (var l in s = vt(s, (function (e) {
            ...
            if (u.recurringDef) {
                ...
                for (var d = 0, p = Rt(u, c, t, r, o.recurringTypes); d < p.length; d++) {
                    var f = p[d], h = pt(l, {start: f, end: r.add(f, c)});
                    s[h.instanceId] = h
                }
            }
        }
    ...
    function kt(e, t) {
        ...
        return "string" == typeof e ? function (e) {
            ...
            return null
        }(e) : "object" == typeof e && e ? xt(e) : "number" == typeof e ? xt(((n = {})[t || "milliseconds"] = e, n)) : null
    }
    ...
    var Bt = {week: 3, separator: 0, omitZeroMinute: 0, meridiem: 0, omitCommas: 0},
        ...
        Gt = /\s*([ap])\.?m\.?/i, qt = /,/g, Yt = /\s+/g, Zt = /\u200e/g, Xt = /UTC|GMT/, Kt = function () {
            function e(e) {
                var t = {}, n = {}, r = 0;
    ...
    function gn(e, t) {
        var n = e.instances[t];
        if (n) {
            var r = e.defs[n.defId], o = En(e, (function (e) {
    ...
    function En(e, t) {
        var n = vt(e.defs, t), r = vt(e.instances, (function (e) {
            return n[e.defId]
        }));
    ...
    var _n = {id: String, groupId: String, title: String, url: String},
        Tn = {start: fn, end: fn, date: fn, allDay: Boolean}, kn = r(r(r({}, _n), Tn), {extendedProps: fn});

    function xn(e, t, n, r, o) {
        void 0 === o && (o = In(n));
        var i = Mn(e, n, o), a = i.refined, s = i.extra, l = function (e, t) {
            var n = null;
            e && (n = e.defaultAllDay);
        ...
        if (u) return (c = Pn(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = {
            typeId: u.typeId,
            typeData: u.typeData,
            duration: u.duration
        }, {def: c, instance: null};
    ...
    function Nn(e) {
        var t = Math.floor(Qe(e.start, e.end)) || 1, n = rt(e.start);
    ...
    function Un(e, t) {
        var n, r, o = [], i = t.start;
        for (e.sort(Ln), n = 0; n < e.length; n += 1) (r = e[n]).start > i && o.push({
            start: i,
            end: r.start
        }), r.end > i && (i = r.end);
    ...
    function jn(e, t, n, r) {
        ...
        for (var d in e.instances) {
            var p = e.instances[d], f = u[(S = e.defs[p.defId]).defId], h = p.range, v = !S.allDay && r ? Hn(h, r) : h,
                g = Wn(v, n);
        ...
        for (var m in o) for (var y = 0, E = Un(o[m], n); y < E.length; y++) {
            var S, D = E[y];
            f = u[(S = a[m]).defId];
            s.push({def: S, ui: f, instance: null, range: D, isStart: !1, isEnd: !1})
        }
        for (var c in i) for (var b = 0, C = Un(i[c], n); b < C.length; b++) {
            D = C[b];
    ...
    function tr(e, t, n, r, o, i, a) {
        ...
        var f = p.range.start, h = p.range.end, v = i || e.start || e.eventRange.range.start,
            g = a || e.end || e.eventRange.range.end, m = rt(f).valueOf() === rt(v).valueOf(),
    ...
    function ar(e, t, n) {
        var o = function (e, t) {
            var n = pn(e, ir), o = n.refined, i = n.extra, a = o.start ? t.createMarkerMeta(o.start) : null,
    ...
    function cr(e, t, n) {
        var r = Mn({editable: !1}, n), o = Pn(r.refined, r.extra, "", e.allDay, !0, n);
        return {def: o, ui: Xn(o, t), instance: pt(o.defId, e.range), range: e.range, isStart: !0, isEnd: !0}
    }

    function dr(e, t, n) {
        n.emitter.trigger("select", r(r({}, pr(e, n)), {
    ...
    function hr(e, t, n, r) {
        var o = Zn(e.defs, t), i = {defs: {}, instances: {}};
        for (var a in e.defs) {
            var s = e.defs[a];
    ...
    function Er(e, t, n) {
        ...
        if (void 0 === n && (n = Sr(t)), "string" == typeof e ? r = {url: e} : "function" == typeof e || Array.isArray(e) ? r = {events: e} : "object" == typeof e && e && (r = e), r) {
            var o = pn(r, n), i = o.refined, a = o.extra, s = function (e, t) {
    ...
    var br = function () {
        ...
        return e.prototype.getCurrentData = function () {
            ...
            var t = this.getCurrentData(), n = kt(e);
            ...
            var r = this.getCurrentData(), o = ar(n, r.dateEnv, kt({days: 1}));
        ...
        return e.prototype.setProp = function (e, t) {
            var n, r;
            if (e in Tn) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead."); else if ("id" === e) t = _n[e](t), this.mutate({standardProps: {publicId: t}}); else if (e in _n) t = _n[e](t), this.mutate({standardProps: (n = {}, n[e] = t, n)}); else if (e in Dn) {
                var o = Dn[e](t);
            ...
            var t = this._context.dateEnv, n = this._instance, r = nn(e);
            ...
            if (n) {
                var r = this._def, o = this._context, i = o.getCurrentData().eventStore, a = gn(i, n.instanceId);
                a = hr(a, {
                    "": {
                        display: "",
                        startEditable: !0,
    ...
    var Ir = function () {
        ...
        return e.prototype.createMarker = function (e) {
            ...
            return null !== n ? {unit: "year", value: n} : null !== (n = this.diffWholeMonths(e, t)) ? {
                unit: "month",
                value: n
            } : null !== (n = tt(e, t)) ? {unit: "week", value: n} : null !== (n = nt(e, t)) ? {
                unit: "day",
                value: n
            } : qe(n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 36e5
            }(e, t)) ? {unit: "hour", value: n} : qe(n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 6e4
            }(e, t)) ? {unit: "minute", value: n} : qe(n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 1e3
            }(e, t)) ? {unit: "second", value: n} : {unit: "millisecond", value: t.valueOf() - e.valueOf()}
        }, e.prototype.countDurationsBetween = function (e, t, n) {
            var r;
            return n.years && null !== (r = this.diffWholeYears(e, t)) ? r / (Pt(n) / 365) : n.months && null !== (r = this.diffWholeMonths(e, t)) ? r / function (e) {
                return Pt(e) / 30
            }(n) : n.days && null !== (r = nt(e, t)) ? r / Pt(n) : (t.valueOf() - e.valueOf()) / Nt(n)
            ...
            return this.weekNumberFunc ? this.weekNumberFunc(this.toDate(e)) : function (e, t, n) {
                var r = e.getUTCFullYear(), o = ot(e, r, t, n);
    ...
    var Yr = {defs: {}, instances: {}}, Zr = function () {
        function e() {
        ...
        return e.prototype.splitProps = function (e) {
            ...
            for (var c in this.eventUiBuilders = gt(n, (function (e, n) {
                ...
                var d = n[c], p = a[c] || Yr, f = this.eventUiBuilders[c];
                u[c] = {
    ...
    function oo(e, t) {
        ...
        var n = window.getComputedStyle(e), r = parseInt(n.borderLeftWidth, 10) || 0,
            ...
            a = parseInt(n.borderBottomWidth, 10) || 0, s = ro(e), l = s.y - r - o, u = {
                borderLeft: r,
                borderRight: o,
                borderTop: i,
                borderBottom: a,
    ...
    function io(e, t, n) {
        void 0 === t && (t = !1);
        var r = n ? e.getBoundingClientRect() : ao(e), o = oo(e, t), i = {
    ...
    var go = FullCalendarVDom.Component, mo = FullCalendarVDom.createElement, yo = FullCalendarVDom.render,
        Eo = FullCalendarVDom.createRef, So = FullCalendarVDom.Fragment, Do = FullCalendarVDom.createContext,
        bo = FullCalendarVDom.createPortal, Co = FullCalendarVDom.flushToDom,
        wo = FullCalendarVDom.unmountComponentAtNode, Ro = function () {
            function e(e, t, n, o) {
                var i = this;
    ...
    var ko = function (e) {
        ...
        }, t.addPropsEquality = Mo, t.addStateEquality = Io, t.contextType = _o, t
    }(go);
    ...
    var Fo = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var e = this.context.pluginHooks.contentTypeHandlers, t = this.props, n = this.customContentInfo,
                o = Go(t.content, t.hookProps), i = null;
    ...
    var $o = function () {
        ...
        return e.prototype.buildPrev = function (e, t, n) {
            ...
            var t = this.props, n = t.dateEnv, r = t.usesMinMaxTime, o = t.slotMinTime, i = t.slotMaxTime, a = e.start,
                s = e.end;
            return r && (Pt(o) < 0 && (a = rt(a), a = n.add(a, o)), Pt(i) > 1 && (s = Ke(s = rt(s), -1), s = n.add(s, i))), {
                start: a,
                end: s
            }
    ...
    function Jo(e, t, n) {
        ...
        return ti({}, function (e, t) {
            var n = Sr(t), r = [].concat(e.eventSources || []), o = [];
    ...
    function oi(e, t, n, o) {
        var i = o.options, a = o.calendarApi, s = o.pluginHooks.eventSourceDefs[e.sourceDefId], l = Ne();
        ...
        recurringTypes: [{
            parse: function (e, t) {
                ...
                return r ? function (e, t, n, r) {
                    var o = e ? mt(e) : null, i = rt(n.start), a = n.end, s = [];
                    for (; i < a;) {
                        var l = void 0;
    ...
    var Ri = function () {
        ...
        return e.prototype.resetOptions = function (e, t) {
            ...
            }(d, e), u.dateProfileGenerator), Bn(p.currentRange, d) || (d = p.currentRange.start);
            ...
            var n = dn([on, e, t]), o = n.locales, i = n.locale, a = this.organizeRawLocales(o), s = a.map,
                l = this.buildLocale(i || a.defaultCode, s).options, u = this.buildPluginHooks(e.plugins || [], Ei),
                c = this.currentCalendarOptionsRefiners = r(r(r(r(r({}, rn), an), sn), u.listenerRefiners), u.optionRefiners),
                d = {}, p = dn([on, l, e, t]), f = {}, h = this.currentCalendarOptionsInput,
            ...
            var a = dn([on, e.optionDefaults, n, o, e.optionOverrides, i]),
                s = r(r(r(r(r(r({}, rn), an), sn), cn), t.listenerRefiners), t.optionRefiners), l = {},
    ...
    var Ui = function (e) {
        ...
        return e.prototype.addSegs = function (e) {
            ...
            var t, n, r = this, o = r.levelCoords, i = r.entriesByLevel, a = r.stackCnts, s = r.strictOrder,
                l = o.length, u = 0, c = 0, d = 0, p = null;
            for (t = 0; t < l && (n = o[t], s || !(n >= d + e.thickness)); t += 1) {
                var f = i[t], h = void 0, v = Bi(f, e.spanStart, Wi);
    ...
    }(), Xi = {}, Ki = {startTime: kt, duration: kt, create: Boolean, sourceId: String};

    function $i(e) {
        var t = pn(e, Ki), n = t.refined, r = t.extra;
        return {
    ...
    var Ji = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            for (var t = this.props, n = this.context.theme, i = [], a = !0, s = 0, l = e; s < l.length; s++) {
                ...
                if ("title" === c) a = !1, i.push(mo("h2", {className: "fc-toolbar-title"}, t.title)); else {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return r.left ? (i = !0, e = r.left) : e = r.start, r.right ? (i = !0, t = r.right) : t = r.end, mo("div", {className: [o || "", "fc-toolbar", i ? "fc-toolbar-ltr" : ""].join(" ")}, this.renderSection("start", e || []), this.renderSection("center", a || []), this.renderSection("end", t || []))
        ...
        function t(t) {
            ...
            return n.handleSegClick = function (e, t) {
                var r = n.component, o = r.context, i = Yn(t);
        ...
        return n(t, e), t.prototype.destroy = function () {
            ...
            var r = this.component, o = r.context, i = Yn(n);
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildViewContext = Ft(To), t.buildViewPropTransformers = Ft(ia), t.buildToolbarProps = Ft(oa), t.handleNavLinkClick = ke("a[data-navlink]", t._handleNavLinkClick.bind(t)), t.headerRef = Eo(), t.footerRef = Eo(), t.interactionsStore = {}, t.registerInteractiveComponent = function (e, n) {
                var r = Gi(e, n), o = [ta, na].concat(t.props.pluginHooks.componentInteractions).map((function (e) {
                    return new e(r)
                }));
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return mo(_o.Provider, {value: l}, n.headerToolbar && mo(Qi, r({
                ref: this.headerRef,
            ...
            }, this.renderView(t), this.buildAppendContent()), n.footerToolbar && mo(Qi, r({
                ref: this.footerRef,
    ...
    function sa(e, t) {
        return nn(!e || t > 10 ? {weekday: "short"} : t > 1 ? {
            weekday: "short",
            month: "numeric",
            day: "numeric",
            omitCommas: !0
    ...
    var ca = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.context, t = e.dateEnv, n = e.options, o = e.theme, i = e.viewApi, a = this.props, s = a.date,
                l = a.dateProfile, u = Kr(s, a.todayRange, null, l), c = [la].concat($r(u, o)),
            ...
            return mo(Lo, {
                ...
                return mo("th", r({
                    ...
                    colSpan: a.colSpan
                }, a.extraDataAttrs), mo("div", {className: "fc-scrollgrid-sync-inner"}, !u.isDisabled && mo("a", r({
                    ref: n,
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.dateEnv, o = t.theme, i = t.viewApi, a = t.options,
                ...
                u = [la].concat($r(l, o), e.extraClassNames || []), c = n.format(s, e.dayHeaderFormat),
            ...
            return mo(Lo, {
                ...
                return mo("th", r({
                    ...
                    colSpan: e.colSpan
                }, e.extraDataAttrs), mo("div", {className: "fc-scrollgrid-sync-inner"}, mo("a", {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var e = this.props, t = this.context,
                ...
                r = t.dateEnv.startOf(n, e.unit), o = t.dateEnv.add(r, kt(1, e.unit)), i = o.valueOf() - n.valueOf();
    ...
    var ga = function () {
        ...
        return e.prototype.sliceRange = function (e) {
            var t = this.getDateDayIndex(e.start), n = this.getDateDayIndex(Ke(e.end, -1)), r = Math.max(0, t),
            ...
            var t = this.indices, n = Math.floor(Qe(this.dates[0], e));
    ...
    function Ca(e, t, n, o) {
        return void 0 === n && (n = {}), !(e.eventDrag && !function (e, t, n, o) {
            ...
            }), p = d.defs, f = d.instances, h = Zn(p, e.eventUiBases);
            var v, g;
            for (var m in u) {
                ...
                for (var _ = i.eventStore, T = 0, k = S.allows; T < k.length; T++) {
                    var x = k[T], M = r(r({}, n), {range: y.range, allDay: D.allDay}), I = _.defs[D.defId],
    ...
    function Ra(e, t, n, r, o) {
        return "businessHours" === e ? _a(wt(r, t, o)) : "string" == typeof e ? _a(En(n, (function (t) {
            return t.groupId === e
        }))) : "object" == typeof e && e ? _a(wt(e, t, o)) : []
    }
    ...
    var ka = /^(visible|hidden)$/, xa = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
    ...
    function Aa(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++) for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1) n.push(mo("col", {
            style: {
    ...
    var ja = function (e) {
        function t() {
            ...
            return t.processCols = Ft((function (e) {
                return e
            }), Oa), t.renderMicroColGroup = Ft(Aa), t.scrollerRefs = new Ma, t.scrollerElRefs = new Ma(t._handleScrollerEl.bind(t)), t.state = {
                shrinkWidth: null,
                forceYScrollbars: !1,
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = e.props, n = e.state, r = e.context, i = t.sections || [], a = this.processCols(t.cols),
                s = this.renderMicroColGroup(a, n.shrinkWidth), l = Wa(t.liquid, r);
            ...
            return "outerContent" in e ? mo(So, {key: e.key}, e.outerContent) : mo("tr", {
                key: e.key,
                className: Va(e, this.props.liquid).join(" ")
            ...
            var r = this.props, o = this.state, i = o.forceYScrollbars, a = o.scrollerClientWidths,
                s = o.scrollerClientHeights, l = Na(r, e), u = Pa(r, e),
                c = r.liquid ? i ? "scroll" : l ? "auto" : "hidden" : "visible", d = e.key, p = Ha(e, n, {
                    tableColGroupNode: t,
                    tableMinWidth: "",
            ...
            return mo("td", {ref: n.elRef}, mo("div", {className: "fc-scroller-harness" + (u ? " fc-scroller-harness-liquid" : "")}, mo(xa, {
            ...
            var e = no(), t = this.scrollerRefs, n = this.scrollerElRefs, r = !1, o = {}, i = {};
    ...
    var Ga = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return mo(Ga, {
                ...
                }, a), s.isStartResizable && mo("div", {className: "fc-event-resizer fc-event-resizer-start"}), s.isEndResizable && mo("div", {className: "fc-event-resizer fc-event-resizer-end"}))
            }))
        }, t
    }(xo);

    function Ya(e) {
        return mo("div", {className: "fc-event-main-frame"}, e.timeText && mo("div", {className: "fc-event-time"}, e.timeText), mo("div", {className: "fc-event-title-container"}, mo("div", {className: "fc-event-title fc-sticky"}, e.event.title || mo(So, null, " "))))
    }
    ...
    }, Xa = nn({day: "numeric"}), Ka = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }

        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options, r = $a({
                date: e.date,
                dateProfile: e.dateProfile,
    ...
    function $a(e) {
        var t = e.date, n = e.dateEnv, o = Kr(t, e.todayRange, null, e.dateProfile);
        return r(r(r({
            date: n.toDate(t),
            view: e.viewApi
        }, o), {dayNumberText: e.showDayNumber ? n.format(t, Xa) : ""}), e.extraProps)
    }
    ...
    var os = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return bo(mo("div", r({className: n.join(" ")}, t.extraAttrs, {ref: this.handleRootEl}), mo("div", {className: "fc-popover-header " + e.getClass("popoverHeader")}, mo("span", {className: "fc-popover-title"}, t.title), mo("span", {
                className: "fc-popover-close " + e.getIconClass("close"),
                onClick: this.handleCloseClick
            })), mo("div", {className: "fc-popover-body " + e.getClass("popoverContent")}, t.children)), t.parentEl)
        }, t.prototype.componentDidMount = function () {
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.linkElRef = Eo(), t.state = {isPopoverOpen: !1}, t.handleClick = function (e) {
                var n = t, r = n.props, o = n.context, i = o.options.moreLinkClick, a = ls(r).start;
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return mo(_o.Consumer, null, (function (n) {
                var r = n.viewApi, o = n.options, i = n.calendarApi, a = o.moreLinkText, s = t.moreCnt, l = ls(t), u = {
                    num: s,
                    shortText: "+" + s,
        ...
        function t(t, n) {
            ...
            return o.isRendering = !1, o.isRendered = !1, o.currentClassNames = [], o.customContentRenderId = 0, o.handleAction = function (e) {
                ...
                if (o.isRendering) {
                    o.isRendered = !0;
                    var e = o.currentData;
                    yo(mo(aa, {options: e.calendarOptions, theme: e.theme, emitter: e.emitter}, (function (t, n, i, a) {
                        return o.setClassNames(t), o.setHeight(n), mo(Wo.Provider, {value: o.customContentRenderId}, mo(ra, r({
                            isHeightAuto: i,
                            forPrint: a
                        }, e)))
                    })), o.el)
    ...
    var fs = 0, hs = 0, vs = !1, gs = function () {
        function e(e) {
            var t = this;
            ...
            }, this.containerEl = e, this.emitter = new uo, e.addEventListener("mousedown", this.handleMouseDown), e.addEventListener("touchstart", this.handleTouchStart, {passive: !0}), 1 === (hs += 1) && window.addEventListener("touchmove", ms, {passive: !1})
        }

        return e.prototype.destroy = function () {
            this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {passive: !0}), (hs -= 1) || window.removeEventListener("touchmove", ms, {passive: !1})
    ...
    var ys = function () {
    ...
    }(Es), bs = "function" == typeof performance ? performance.now : Date.now, Cs = function () {
        function e() {
            var e = this;
        ...
        return e.prototype.start = function (e, t) {
            ...
            if (this.isEnabled) {
                ...
                o < 0 ? this.everMovedUp = !0 : o > 0 && (this.everMovedDown = !0), i < 0 ? this.everMovedLeft = !0 : i > 0 && (this.everMovedRight = !0), this.pointerScreenX = n, this.pointerScreenY = r, this.isAnimating || (this.isAnimating = !0, this.requestAnimation(bs()))
            }
        ...
        function t(t) {
            ...
            n.handlePointerDown = function (e) {
                ...
                if (!n.dragging.pointer.wasTouchScroll) {
                    ...
                    if (i && a && Ts(i, a)) {
                        var s = t.context, l = r(r({}, ks(i.dateSpan, s)), {
                            dayEl: i.dayEl,
                            jsEvent: e.origEvent,
            ...
            }, n.dragging = new ws(t.el), n.dragging.autoScroller.isEnabled = !1;
        ...
        function t(t) {
            ...
            n.dragSelection = null, n.handlePointerDown = function (e) {
                ...
                if (e) {
                    ...
                    }(s, e, o.pluginHooks.dateSelectionTransformers)), i && Da(i, e.dateProfile, o) || (a = !0, i = null)
                }
                i ? o.dispatch({
                    type: "SELECT_DATES",
                    selection: i
                }) : t || o.dispatch({type: "UNSELECT_DATES"}), a ? He() : Oe(), t || (n.dragSelection = i)
            }, n.handlePointerUp = function (e) {
                n.dragSelection && (dr(n.dragSelection, e, n.component.context), n.dragSelection = null)
            };
            var o = t.component.context.options, i = n.dragging = new ws(t.el);
    ...
    var Is = function (e) {
        function t(n) {
            ...
            o.subjectEl = null, o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingContext = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function (e) {
                ...
                var u = o.subjectSeg = Yn(e.subjectEl), c = (o.eventRange = u.eventRange).instance.instanceId;
                ...
                if (o.isDragging) {
                    ...
                    if (e) {
                        ...
                        i === a || d.editable && d.droppable ? (s = function (e, t, n) {
                            ...
                            return u
                        }(r, e, a.getCurrentData().pluginHooks.eventDragMutationMassagers)) && (l = hr(n, a.getCurrentData().eventUiBases, s, a), c.mutatedEvents = l, Sa(c, e.dateProfile, a) || (u = !0, s = null, l = null, c.mutatedEvents = {
                            defs: {},
                            instances: {}
                        })) : a = null
                    }
                    o.displayDrag(a, c), u ? He() : Oe(), t || (i === a && Ts(r, e) && (s = null), o.dragging.setMirrorNeedsRevert(!s), o.dragging.setMirrorIsVisible(!e || !document.querySelector(".fc-event-mirror")), o.receivingContext = a, o.validMutation = s, o.mutatedRelevantEvents = l)
                }
                ...
                if (o.isDragging) {
                    var t = o.component.context, n = t.viewApi, i = o, a = i.receivingContext, s = i.validMutation,
                        l = o.eventRange.def, u = o.eventRange.instance, c = new Cr(t, l, u), d = o.relevantEvents,
                    ...
                    if (o.clearDrag(), t.emitter.trigger("eventDragStop", {
                        ...
                        if (a === t) {
                            ...
                            for (var v = {
                                oldEvent: c, event: h, relatedEvents: Rr(p, t, u), revert: function () {
                            ...
                            var S = {
                                event: c, relatedEvents: Rr(d, t, u), revert: function () {
                                    t.dispatch({type: "MERGE_EVENTS", eventStore: d})
                                }
                            };
                            ...
                            var D = p.defs[l.defId], b = p.instances[u.instanceId], C = new Cr(a, D, b);
                            a.dispatch({type: "MERGE_EVENTS", eventStore: p});
                            var w = {
                                event: C, relatedEvents: Rr(p, a, b), revert: function () {
                            ...
                            }), a.emitter.trigger("drop", r(r({}, ks(f.dateSpan, a)), {
                                draggedEl: e.subjectEl,
                                jsEvent: e.origEvent,
            ...
            var i = o.component.context.options, a = o.dragging = new ws(n.el);
    ...
    var Ps = function (e) {
        function t(t) {
            ...
            n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function (e) {
                var t = n.component, r = Yn(n.querySegEl(e)), o = n.eventRange = r.eventRange;
                ...
                l && (u = hr(i, o.getCurrentData().eventUiBases, l, o), d.mutatedEvents = u, Sa(d, e.dateProfile, o) || (c = !0, l = null, u = null, d.mutatedEvents = null)), u ? o.dispatch({
                    type: "SET_EVENT_RESIZE",
                    state: d
                }) : o.dispatch({type: "UNSET_EVENT_RESIZE"}), c ? He() : Oe(), t || (l && Ts(a, e) && (l = null), n.validMutation = l, n.mutatedRelevantEvents = u)
            }, n.handleDragEnd = function (e) {
                var t = n.component.context, o = n.eventRange.def, i = n.eventRange.instance, a = new Cr(t, o, i),
                ...
                if (t.emitter.trigger("eventResizeStop", {
                    ...
                    var c = {
                        oldEvent: a, event: u, relatedEvents: Rr(l, t, i), revert: function () {
            ...
            var o = t.component, i = n.dragging = new ws(t.el);
    ...
    var Ns = function () {
        ...
        function e(e, t) {
            ...
            this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
                ...
                e && (a = e.context, n.canDropElOnCalendar(o.subjectEl, a) && (s = function (e, t, n) {
                    ...
                    var l = Mn(o, n), u = l.refined, c = l.extra,
                ...
                }(e.dateSpan, n.dragMeta, a), u.mutatedEvents = vn(s), (l = !Sa(u, e.dateProfile, a)) && (u.mutatedEvents = {
                    defs: {},
                    instances: {}
                ...
                if (n.clearDrag(), o && i) {
                    ...
                    if (o.emitter.trigger("drop", r(r({}, ks(a.dateSpan, o)), {
                        draggedEl: e.subjectEl,
                        jsEvent: e.origEvent,
                        view: s
                    })), l.create) {
        ...
        return e.prototype.buildDragMeta = function (e) {
            return "object" == typeof this.suppliedDragMeta ? $i(this.suppliedDragMeta) : "function" == typeof this.suppliedDragMeta ? $i(this.suppliedDragMeta(e)) : $i((t = function (e, t) {
                var n = Xi.dataAttrPrefix, r = (n ? n + "-" : "") + t;
    ...
    var Us = function () {
        function e(e, t) {
            ...
            r.touchScrollAllowed = !1, null != t.itemSelector && (r.pointer.selector = t.itemSelector), null != t.appendTo && (r.mirror.parentNode = t.appendTo), r.emitter.on("pointerdown", this.handlePointerDown), r.emitter.on("dragstart", this.handleDragStart), new As(r, t.eventData)
        }
        ...
        function e(e, t) {
            ...
            "string" == typeof t.itemSelector ? r.pointer.selector = t.itemSelector : n === document && (r.pointer.selector = "[data-event]"), "string" == typeof t.mirrorSelector && (r.mirrorSelector = t.mirrorSelector), new As(r, t.eventData)
        }
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t) {
            var n = this.props, r = this.context, o = [], i = za(r.options);
            return e && o.push({
                type: "header",
                key: "header",
                isSticky: i,
            ...
            var i = this.props, a = this.context, s = !i.forPrint && za(a.options), l = !i.forPrint && Ba(a.options),
                u = [];
            return e && u.push({
                type: "header",
                key: "header",
    ...
    var Gs = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context.options.navLinks ? {"data-navlink": Jr(e.date), tabIndex: 0} : {};
            return mo(Ka, {
                date: e.date,
                dateProfile: e.dateProfile,
                todayRange: e.todayRange,
    ...
    var Xs = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options.eventTimeFormat || Ys,
    ...
    function $s(e) {
        ...
        }), e.timeText && mo("div", {className: "fc-event-time"}, e.timeText), mo("div", {className: "fc-event-title"}, e.event.title || mo(So, null, " ")))
    }
    ...
    var el = nn({week: "narrow"}), tl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.rootElRef = Eo(), t.handleRootEl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return mo(Ja, {
                ...
                return mo("td", r({
                    ...
                    ref: t.innerElRef
                }, t.showWeekNumber && mo(ns, {date: a, defaultFormat: el}, (function (e, t, n, o) {
    ...
    function nl(e, t, n, r, o, i, a) {
        ...
        for (var p = s.addSegs(l), f = function (e, t, n) {
            for (var r = function (e, t) {
                ...
                for (var g = 0, m = l; g < m.length; g++) {
                    ...
                    var y, E = y.spanEnd - y.spanStart > 1, S = y.spanStart === s;
        ...
        for (var b = 0, C = p; b < C.length; b++) {
            var w = C[b], R = e[w.segInput.index];
            v[w.spanStart].push({seg: R, isVisible: !1, isAbsolute: !0, absoluteTop: 0, marginTop: 0});
            for (D = w.spanStart; D < w.spanEnd; D += 1) m[D] += 1, h[D].push({
                seg: rl(R, D, D + 1, a),
                isVisible: !1,
                isAbsolute: !1,
                absoluteTop: 0,
    ...
    function rl(e, t, n, o) {
        ...
        var i = e.eventRange, a = i.range, s = Wn(a, {start: o[t].date, end: Ke(o[n - 1].date, 1)});
        return r(r({}, e), {
            firstCol: t,
            lastCol: n - 1,
    ...
    var ol = function (e) {
        ...
        return n(t, e), t.prototype.addSegs = function (t) {
            ...
            var i = this.entriesByLevel, a = this.forceHidden, s = t.nextLevel - 1;
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.cellElRefs = new Ma, t.frameElRefs = new Ma, t.fgElRefs = new Ma, t.segHarnessRefs = new Ma, t.rootElRef = Eo(), t.state = {
                framePositions: null,
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this, n = t.props, r = t.state, o = t.context.options, i = n.cells.length,
                a = Bs(n.businessHourSegs, i), s = Bs(n.bgEventSegs, i), l = Bs(this.getHighlightSegs(), i),
            ...
            return mo("tr", {ref: this.rootElRef}, n.renderIntro && n.renderIntro(), n.cells.map((function (t, r) {
    ...
    var al = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitBusinessHourSegs = Ft(zs), t.splitBgEventSegs = Ft(zs), t.splitFgEventSegs = Ft(zs), t.splitDateSelectionSegs = Ft(zs), t.splitEventDrag = Ft(js), t.splitEventResize = Ft(js), t.rowRefs = new Ma, t.handleRootEl = function (e) {
                t.rootEl = e, e ? t.context.registerInteractiveComponent(t, {
                    el: e,
    ...
    var ll = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context;
            return mo(al, r({ref: this.tableRef}, this.slicer.sliceProps(e, e.dateProfile, e.nextDayThreshold, t, e.dayTableModel), {
                dateProfile: e.dateProfile,
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.context, n = t.options, r = t.dateProfileGenerator, o = this.props,
                i = this.buildDayTableModel(o.dateProfile, r), a = n.dayHeaders && mo(ha, {
                    ref: this.headerRef,
    ...
    var pl = Ho({
        initialView: "dayGridMonth", views: {
            dayGrid: {
                component: cl, dateProfileGeneratorClass: function (e) {
                    function t() {
                        return null !== e && e.apply(this, arguments) || this
                    }
    ...
    }(Zr), hl = nn({hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "short"});
    ...
    function vl(e) {
        ...
        return mo(_o.Consumer, null, (function (n) {
            ...
            return mo(Lo, {
                ...
                }, mo("div", {className: "fc-timegrid-slot-label-frame fc-scrollgrid-shrink-frame"}, mo("div", {
    ...
    var ml = function (e) {
    ...
    }(xo), yl = nn({week: "short"}), El = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.allDaySplitter = new fl, t.headerElRef = Eo(), t.rootElRef = Eo(), t.scrollerElRef = Eo(), t.state = {slatCoords: null}, t.handleScrollTopRequest = function (e) {
                var n = t.scrollerElRef.current;
                n && (n.scrollTop = e)
            }, t.renderHeadAxis = function (e, n) {
                void 0 === n && (n = "");
                var o = t.context.options, i = t.props.dateProfile.renderRange, a = Qe(i.start, i.end),
                    s = o.navLinks && 1 === a ? {"data-navlink": Jr(i.start, "week"), tabIndex: 0} : {};
                return o.weekNumbers && "day" === e ? mo(ns, {
                    date: i.start,
                    defaultFormat: yl
                }, (function (e, t, o, i) {
                    return mo("th", {
                ...
                })) : mo("th", {className: "fc-timegrid-axis"}, mo("div", {
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t, n) {
            var r = this.context, o = this.props, i = [], a = za(r.options);
            return e && i.push({
                type: "header",
                key: "header",
                isSticky: a,
                ...
                type: "body",
                key: "all-day-divider",
                outerContent: mo("tr", {className: "fc-scrollgrid-section"}, mo("td", {className: "fc-timegrid-divider " + r.theme.getClass("tableCellShaded")}))
            })), i.push({
                type: "body",
                key: "body",
                liquid: !0,
            ...
            var u = this.context, c = this.props, d = !c.forPrint && za(u.options), p = !c.forPrint && Ba(u.options),
                f = [];
            e && f.push({
                type: "header",
                key: "header",
                ...
                key: "all-day-divider",
                type: "body",
                outerContent: mo("tr", {className: "fc-scrollgrid-section"}, mo("td", {
                    colSpan: 2,
            ...
            return f.push({
                ...
                chunks: [{
                    key: "axis", content: function (e) {
                        return mo("div", {className: "fc-timegrid-axis-chunk"}, mo("table", {style: {height: e.expandRows ? e.clientHeight : ""}}, e.tableColGroupNode, mo("tbody", null, mo(ml, {slatMetas: i}))), mo("div", {className: "fc-timegrid-now-indicator-container"}, mo(pa, {unit: h ? "minute" : "day"}, (function (e) {
                            var t = h && a && a.safeComputeTop(e);
                            return "number" == typeof t ? mo(Za, {isAxis: !0, date: e}, (function (e, n, r, o) {
                                return mo("div", {
                                    ref: e,
                ...
                type: "footer",
                isSticky: !0,
                chunks: [{key: "axis", content: Fa}, {key: "cols", content: Fa}]
    ...
    var Dl = function () {
        ...
        return e.prototype.safeComputeTop = function (e) {
            ...
            if (Bn(t.currentRange, e)) {
                var n = rt(e), r = e.valueOf() - n.valueOf();
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return mo("tbody", null, e.slatMetas.map((function (i, a) {
                ...
                return mo("tr", {key: i.key, ref: o.createRef(i.key)}, e.axis && mo(vl, r({}, i)), mo(Lo, {
                    hookProps: s,
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, e.tableColGroupNode, mo(bl, {slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas})))
        }, t.prototype.componentDidMount = function () {
            this.updateSizing()
        }, t.prototype.componentDidUpdate = function () {
            this.updateSizing()
            ...
            n.onCoords && null !== n.clientWidth && (this.rootElRef.current.offsetHeight && n.onCoords(new Dl(new co(this.rootElRef.current, (e = this.slatElRefs.currentMap, n.slatMetas.map((function (t) {
                return e[t.key]
    ...
    function kl(e, t, n) {
        ...
        var i, a, s, l = Fi(o.addSegs(e)), u = function (e) {
            var t = e.entriesByLevel, n = Pl((function (e, t) {
                return e + ":" + t
            }), (function (o, i) {
        ...
        return i = u, a = 1, s = Pl((function (e, t, n) {
            return Vi(e)
        }), (function (e, t, n) {
    ...
    var Nl = nn({hour: "numeric", minute: "2-digit", meridiem: !1}), Hl = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return this.props.isShort && e.push("fc-timegrid-event-short"), mo(qa, r({}, this.props, {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return mo(Ja, {
                ...
                }, u, t.extraDataAttrs), mo("div", {className: "fc-timegrid-col-frame"}, mo("div", {className: "fc-timegrid-col-bg"}, e.renderFillSegs(t.businessHourSegs, "non-business"), e.renderFillSegs(t.bgEventSegs, "bg-event"), e.renderFillSegs(t.dateSelectionSegs, "highlight")), mo("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(s, a)), mo("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(i, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(o))), mo("div", {className: "fc-timegrid-now-indicator-container"}, e.renderNowIndicator(t.nowIndicatorSegs)), mo(Ol, {
                    date: t.date,
                    dateProfile: t.dateProfile,
                    todayRange: t.todayRange,
                    extraHookProps: t.extraHookProps
            ...
            var a = this, s = this.context.options, l = s.eventMaxStack, u = s.eventShortHeight, c = s.eventOrderStrict,
                d = this.props, p = d.eventSelection, f = d.todayRange, h = d.nowDate, v = n || o || i,
                g = this.buildSegInputs(e), m = v ? kl(g) : this.computeFgSegPlacements(g, c, l), y = m.segRects,
                E = m.hiddenGroups;
            return mo(So, null, this.renderHiddenGroups(E, e), y.map((function (s) {
                var l = e[s.segInput.index], c = l.eventRange.instance.instanceId,
            ...
            var n = this, r = this.props, o = r.extraDateSpan, i = r.dateProfile, a = r.todayRange, s = r.nowDate,
                l = r.eventSelection, u = r.eventDrag, c = r.eventResize;
            return mo(So, null, e.map((function (e) {
                var r, d, p = n.computeSegTopBottomCss(e), f = (r = e.entries, d = t, r.map((function (e) {
            ...
            for (var t = this.props, n = t.date, r = t.slatCoords, o = this.context.options.eventMinHeight, i = [], a = 0; a < e.length; a += 1) {
                var s = e[a], l = r.computeDateTop(s.start, n), u = Math.max(l + (o || 0), r.computeDateTop(s.end, n));
    ...
    function Ul(e, t) {
        ...
        return mo(So, null, e.map((function (e) {
            ...
            return mo("div", {key: t, style: {visibility: l[t] ? "hidden" : ""}}, mo(Hl, r({
                seg: e,
                isDragging: !1,
                isResizing: !1,
                isDateSelecting: !1,
    ...
    var Ll = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitFgEventSegs = Ft(wl), t.splitBgEventSegs = Ft(wl), t.splitBusinessHourSegs = Ft(wl), t.splitNowIndicatorSegs = Ft(wl), t.splitDateSelectionSegs = Ft(wl), t.splitEventDrag = Ft(Rl), t.splitEventResize = Ft(Rl), t.rootElRef = Eo(), t.cellElRefs = new Ma, t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, t.tableColGroupNode, mo("tbody", null, mo("tr", null, t.axis && mo("td", {className: "fc-timegrid-col fc-timegrid-axis"}, mo("div", {className: "fc-timegrid-col-frame"}, mo("div", {className: "fc-timegrid-now-indicator-container"}, "number" == typeof n && mo(Za, {
                isAxis: !0,
                date: t.nowDate
            }, (function (e, t, r, o) {
                return mo("div", {
    ...
    var Wl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.processSlotOptions = Ft(Vl), t.state = {slatCoords: null}, t.handleRootEl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            if (null != p && null != f) {
                var h = this.props.cells[p], v = l.positions.tops[f], g = l.positions.getHeight(f), m = (t - v) / g,
                    y = f * d + Math.floor(m * d), E = this.props.cells[p].date, S = Mt(s.slotMinTime, It(c, y)),
    ...
    var Fl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return mo(pa, {unit: a ? "minute" : "day"}, (function (l, u) {
                return mo(Wl, r({ref: e.timeColsRef}, e.slicer.sliceProps(t, o, null, n, s), {
                    forPrint: t.forPrint,
                    axis: t.axis,
                    dateProfile: o,
    ...
    var Zl = Ho({
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = e.dayDate, n = e.todayRange, o = this.context, i = o.theme, a = o.dateEnv,
                s = o.options, l = o.viewApi, u = Kr(t, n), c = s.listDayFormat ? a.format(t, s.listDayFormat) : "",
                d = s.listDaySideFormat ? a.format(t, s.listDaySideFormat) : "", p = s.navLinks ? Jr(t) : null,
    ...
    var $l = nn({hour: "numeric", minute: "2-digit", meridiem: "short"}), Jl = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }

        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = e.seg, r = t.options.eventTimeFormat || $l;
            return mo(Ga, {
                seg: n,
                timeText: "",
                disableDragging: !0,
                ...
                return mo("tr", {
                    ...
                    return null
                }(n, r, t), mo("td", {className: "fc-list-event-graphic"}, mo("span", {
    ...
    var tu = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.computeDateVars = Ft(ru), t.eventStoreToSegs = Ft(t._eventStoreToSegs), t.setRootEl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return mo(qo, {viewSpec: n.viewSpec, elRef: this.setRootEl}, (function (n, o) {
                return mo("div", {ref: n, className: r.concat(o).join(" ")}, mo(xa, {
            ...
            var n, r, o, i = this.context.dateEnv, a = this.context.options.nextDayThreshold, s = e.range,
                l = e.def.allDay, u = [];
            for (n = 0; n < t.length; n += 1) if ((r = Wn(s, t[n])) && (o = {
                component: this,
                eventRange: e,
                start: r.start,
                end: r.end,
    ...
    }, au.prototype.baseIconClass = "fa", au.prototype.iconClasses = {
        close: "fa-times",
    ...
    }, au.prototype.iconOverrideOption = "bootstrapFontAwesome", au.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome", au.prototype.iconOverridePrefix = "fa-";
    var su = Ho({themeClasses: {bootstrap: au}}), lu = "https://www.googleapis.com/calendar/v3/calendars";
    var uu = Ho({
        eventSourceDefs: [{
            parseMeta: function (e) {
    ...
    return Ei.push(Vs, pl, Zl, iu, su, uu), e.BASE_OPTION_DEFAULTS = on, e.BASE_OPTION_REFINERS = rn, e.BaseComponent = xo, e.BgEvent = es, e.BootstrapTheme = au, e.Calendar = ps, e.CalendarApi = br, e.CalendarContent = ra, e.CalendarDataManager = Ri, e.CalendarDataProvider = Ai, e.CalendarRoot = aa, e.Component = go, e.ContentHook = Vo, e.CustomContentRenderContext = Wo, e.DateComponent = No, e.DateEnv = Ir, e.DateProfileGenerator = $o, e.DayCellContent = Ka, e.DayCellRoot = Ja, e.DayGridView = cl, e.DayHeader = ha, e.DaySeriesModel = ga, e.DayTable = ul, e.DayTableModel = ma, e.DayTableSlicer = ll, e.DayTimeCols = zl, e.DayTimeColsSlicer = Fl, e.DayTimeColsView = ql, e.DelayedRunner = bi, e.Draggable = Us, e.ElementDragging = Zi, e.ElementScrollController = fo, e.Emitter = uo, e.EventApi = Cr, e.EventRoot = Ga, e.EventSourceApi = ye, e.FeaturefulElementDragging = ws, e.Fragment = So, e.Interaction = ji, e.ListView = tu, e.MoreLinkRoot = as, e.MountHook = zo, e.NamedTimeZoneImpl = Ui, e.NowIndicatorRoot = Za, e.NowTimer = pa, e.PointerDragging = gs, e.PositionCache = co, e.RefMap = Ma, e.RenderHook = Lo, e.ScrollController = po, e.ScrollResponder = Ro, e.Scroller = xa, e.SegHierarchy = Li, e.SimpleScrollGrid = ja, e.Slicer = ya, e.Splitter = Zr, e.StandardEvent = qa, e.Table = al, e.TableDateCell = ca, e.TableDowCell = da, e.TableView = Fs, e.Theme = vo, e.ThirdPartyDraggable = Ws, e.TimeCols = Wl, e.TimeColsSlatsCoords = Dl, e.TimeColsView = El, e.ViewApi = mr, e.ViewContextType = _o, e.ViewRoot = qo, e.WeekNumberRoot = ns, e.WindowScrollController = ho, e.addDays = Ke, e.addDurations = Mt, e.addMs = $e, e.addWeeks = Xe, e.allowContextMenu = We, e.allowSelection = Ue, e.applyMutationToEventStore = hr, e.applyStyle = we, e.applyStyleProp = Re, e.asCleanDays = function (e) {
        ...
        return Nt(e) / 1e3
    }, e.binarySearch = Bi, e.buildClassNameNormalizer = Bo, e.buildDayRanges = Bl, e.buildDayTableModel = dl, e.buildEntryKey = Vi, e.buildEventApis = Rr, e.buildEventRangeKey = or, e.buildHashFromArray = function (e, t) {
        for (var n = {}, r = 0; r < e.length; r += 1) {
            var o = t(e[r], r);
            n[o[0]] = o[1]
        }
        return n
    }, e.buildIsoString = At, e.buildNavLinkData = Jr, e.buildSegCompareObj = $n, e.buildSegTimeText = tr, e.buildSlatMetas = Gl, e.buildTimeColsModel = Yl, e.collectFromHash = Ct, e.combineEventUis = wn,e.compareByFieldSpec = ze,e.compareByFieldSpecs = Fe,e.compareNumbers = Ge,e.compareObjs = Dt,e.computeEarliestSegStart = us,e.computeEdges = oo,e.computeFallbackHeaderFormat = sa,e.computeHeightAndMargins = function (e) {
        ...
        void 0 === t && (t = {});
        var n = Ur(t), r = nn(t), o = n.createMarkerMeta(e);
        ...
        var r = Ur("object" == typeof n && n ? n : {}), o = nn(n), i = r.createMarkerMeta(e), a = r.createMarkerMeta(t);
    ...
    },e.getAllowYScrolling = Na,e.getCanVGrowWithinCell = qr,e.getClippingParents = so,e.getDateMeta = Kr,e.getDayClassNames = $r,e.getDefaultEventEnd = fr,e.getElSeg = Yn,e.getEntrySpanEnd = Wi,e.getEventClassNames = rr,e.getIsRtlScrollbarOnLeft = to,e.getRectCenter = jr,e.getRelevantEvents = gn,e.getScrollGridClassNames = Wa,e.getScrollbarWidths = no,e.getSectionClassNames = Va,e.getSectionHasLiquidHeight = Pa,e.getSegMeta = nr,e.getSlotClassNames = function (e, t) {
    ...
    },e.getStickyFooterScrollbar = Ba,e.getStickyHeaderDates = za,e.getUnequalProps = St,e.globalLocales = Pr,e.globalPlugins = Ei,e.greatestDurationDenominator = Ot,e.groupIntersectingEntries = Fi,e.guid = Ne,e.hasBgRendering = Gn,e.hasShrinkWidth = La,e.identity = fn,e.interactionSettingsStore = Yi,e.interactionSettingsToStore = qi,e.intersectRanges = Wn,e.intersectRects = zr,e.isArraysEqual = Vt,e.isColPropsEqual = Oa,e.isDateSelectionValid = Da,e.isDateSpansEqual = sr,e.isInt = qe,e.isInteractionValid = Sa,e.isMultiDayRange = On,e.isPropsEqual = Et,e.isPropsValid = Ca,e.isValidDate = ct,e.listenBySelector = xe,e.mapHash = gt,e.memoize = Ft,e.memoizeArraylike = function (e, t, n) {
        var r = this, o = [], i = [];
        return function (a) {
        ...
        return function (a) {
            var s = {};
            for (var l in a) if (i[l]) if (Vt(o[l], a[l])) s[l] = i[l]; else {
                n && n(i[l]);
                var u = e.apply(r, a[l]);
                s[l] = t && t(u, i[l]) ? i[l] : u
    ...
    },e.memoizeObjArg = zt,e.mergeEventStores = yn,e.multiplyDuration = It,e.padStart = je,e.parseBusinessHours = Vr,e.parseClassNames = Sn,e.parseDragMeta = $i,e.parseEventDef = Pn,e.parseFieldSpecs = Ve,e.parseMarker = Mr,e.pointInsideRect = Fr,e.preventContextMenu = Le,e.preventDefault = Te,e.preventSelection = Ae,e.rangeContainsMarker = Bn,e.rangeContainsRange = zn,e.rangesEqual = Vn,e.rangesIntersect = Fn,e.refineEventDef = Mn,e.refineProps = pn,e.removeElement = Ee,e.removeExact = function (e, t) {
        for (var n = 0, r = 0; r < e.length;) e[r] === t ? (e.splice(r, 1), n += 1) : r += 1;
        return n
    },e.render = yo,e.renderChunkContent = Ha,e.renderFill = Qa,e.renderMicroColGroup = Aa,e.renderScrollShim = Fa,e.requestJson = gi,e.sanitizeShrinkWidth = Ua,e.setElSeg = qn,e.setRef = Po,e.sliceEventStore = jn,e.sliceEvents = function (e, t) {
    ...
    },e.triggerDateSelect = dr,e.unmountComponentAtNode = wo,e.unpromisify = lo,e.version = "5.7.2",e.whenTransitionDone = Ie,e.wholeDivideDurations = Ht,Object.defineProperty(e, "__esModule", {value: !0}),e
}({});
