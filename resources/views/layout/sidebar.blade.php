        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item">
                ...
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="/admin/salaries/pending">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Đang chờ</span>
                        </a>
                    </li>
                    <li><a class="d-flex align-items-center" href="/admin/salaries/approved">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Đã duyệt</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="/admin/config">
                    ...
                    <span class="menu-title text-truncate">Thiết lập</span>
                </a>
            </li>
